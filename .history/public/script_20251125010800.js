// ===== CONFIG =====
const CLOUD_RUN_URL = "https://etl-transform-service-564878881238.asia-south1.run.app/"; // <--- update if needed
// ==================
...
const serviceUrlShort = document.getElementById("serviceUrlShort");

serviceUrlShort.textContent = CLOUD_RUN_URL.replace(/^https?:\/\//, "").replace(/\/$/, "");
